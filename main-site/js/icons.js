// Inline SVG icon set. Icons inherit colour via currentColor.
...
export const icons = {
  ...
  // Filled on purpose; it reads as a heart at footer size. Colour comes from CSS.
  heart: `<svg viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M12 20.7 3.9 12.6a5.1 5.1 0 0 1 7.2-7.2l.9.9.9-.9a5.1 5.1 0 0 1 7.2 7.2z"/></svg>`,
};
